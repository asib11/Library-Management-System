...
public class AddStudent extends JFrame implements ActionListener{
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "BBA", "CSE", "CSIT", "Civil", "B.A. English", "EEE", "Other" }));
	...
	comboBox_2.setModel(
			new DefaultComboBoxModel(new String[] { "1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th" , "9th" , "10th" , "11th" , "12th" }));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] {  "B.Sc in CSE", "B.Sc in EEE", "B.Sc in Civil", "B.Sc in CSIT", "B.Sc in textile Engineering","B.A in English", "LLB", "B.Sc in Economics", "MBA", "BBA","EMBA","MEB","M.A in English","M.A in ELT","M.Sc in Economics","M.Sc in Mathematics" }));
